...
**Note:** Most users should use the [x402](https://pub.dev/packages/x402) package directly, as it exports the EVM functionality and provides a more convenient multi-chain experience.
